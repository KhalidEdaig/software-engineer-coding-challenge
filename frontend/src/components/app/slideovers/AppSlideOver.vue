  ...
  <div class="fixed inset-0 overflow-hidden z-40">
    <div class="absolute inset-0 overflow-hidden">
      <section class="absolute inset-y-0 right-0 pl-10 max-w-full flex">
        ...
        >
          <div class="w-screen max-w-md" v-show="isShown">
            <div
              class="h-full divide-y divide-gray-200 flex flex-col bg-white shadow-xl"
            >
              <div class="h-0 flex-1 space-y-6 overflow-y-scroll">
                <header class="space-y-1 py-6 px-4 bg-purple-700 sm:px-6">
                  <div class="flex items-center justify-between space-x-3">
                    ...
                    <div class="h-7 flex items-center">
                      <button
                        ...
                        class="text-gray-50 hover:text-white transition ease-in-out duration-150"
                      >
                        <svg
                          class="h-6 w-6"
                          fill="none"
